from .._bootstrap.database_bootstrapper import DatabaseBootstrapper
from .._infrastructure.aiomysql.aiomysql_connection import AioMySQLConnection
from .._services.database_wrapper import DatabaseWrapper
...
class DatabaseBuilder:
    ...
    async def build(self) -> DatabaseWrapper:
        bootstrapper = DatabaseBootstrapper(self._config_path)
